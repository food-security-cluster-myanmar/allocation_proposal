...
states <- msna %>%
  ...
  left_join(pin %>%
            ...
            by = "state") %>% 
  mutate(secure = ifelse(domain == "secure", 
                         pc_weight * population, 0), 
         marginally_secure = ifelse(domain == "marginally_secure", 
                                    pc_weight * population, 0), 
    moderately_insecure = ifelse(domain == "moderately_insecure", 
                                      pc_weight * population, 0),   
